...
const ACCOUNTS = [
  ...
  { handle: 'maddogbrewcheltenham',      venue: 'Mad Dog Brew Co' },
  { handle: 'thekemblecheltenham',       venue: 'The Kemble' },
  { handle: 'retreatcheltenham',         venue: 'Retreat Cheltenham' },
  { handle: 'the_beehive_montpellier',   venue: 'The Beehive Montpellier' },
];
